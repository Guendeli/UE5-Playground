...
// End Cross Module References
	DEFINE_FUNCTION(IHealthInterface::execOnDamage)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnDamage_Implementation();
		P_NATIVE_END;
	}
	...
	void IHealthInterface::OnDamage()
	{
	...
	void UHealthInterface::StaticRegisterNativesUHealthInterface()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "OnDamage", &IHealthInterface::execOnDamage },
			{ "OnDeath", &IHealthInterface::execOnDeath },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UHealthInterface_OnDamage_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UHealthInterface_OnDamage_Statics::Function_MetaDataParams[] = {
		{ "Category", "Health" },
		{ "ModuleRelativePath", "HealthInterface.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UHealthInterface_OnDamage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UHealthInterface, nullptr, "OnDamage", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UHealthInterface_OnDamage_Statics::Function_MetaDataParams), Z_Construct_UFunction_UHealthInterface_OnDamage_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_UHealthInterface_OnDamage()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UHealthInterface_OnDamage_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHealthInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHealthInterface_OnDamage, "OnDamage" }, // 1249240488
	...
	static FName NAME_UHealthInterface_OnDamage = FName(TEXT("OnDamage"));
	void IHealthInterface::Execute_OnDamage(UObject* O)
	{
		check(O != NULL);
		check(O->GetClass()->ImplementsInterface(UHealthInterface::StaticClass()));
		UFunction* const Func = O->FindFunction(NAME_UHealthInterface_OnDamage);
		if (Func)
		{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Sandbox_Source_Sandbox_HealthInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHealthInterface, UHealthInterface::StaticClass, TEXT("UHealthInterface"), &Z_Registration_Info_UClass_UHealthInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHealthInterface), 987203909U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Sandbox_Source_Sandbox_HealthInterface_h_909552136(TEXT("/Script/Sandbox"),
